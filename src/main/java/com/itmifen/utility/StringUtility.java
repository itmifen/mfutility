...
public class StringUtility {
    ...
    private  static   Pattern SPECCHAR = Pattern.compile("\\s*|\t|\r|\n");
    ...
    public  static String joinString(String[] array, String symbol) {
        ...
        if (array != null) {
            ...
            if (result.length() > 1 && ValidUtility.valid(symbol)) {
    ...
    public  static String join(String linkStr,String ... strs){
        ...
        if (result.length() > 1 && ValidUtility.valid(linkStr)) {
    ...
    public  static String replaceBlank(String str) {
        if (str != null) {
            Matcher m = SPECCHAR.matcher(str);
            str = m.replaceAll("");
        }
        return str;
    }
